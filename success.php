<?php
    ...
    if(!isset($_SESSION['email'])){
        ...
        $user_id=$_GET['id'];
        $confirm_query="UPDATE users_items set status='Confirmed' where id='$user_id'";
                    ...
                    <div class="col-xs-6">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                            	<?php
                            	echo "<center><h3><script>alert('Your order is confirmed. Thank you for shopping with us.');</script></h3></center>";
