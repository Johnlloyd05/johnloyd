...
<body id="page-top" style="background-image:url(pic1.jpg); background-size: 1400px;">
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid" style="margin-top:14%;">
        <center> <h1> WELCOME TO <br> ONLINE SHOP SYSTEM</h1></center>
         ...
         <div id="bannerImage">
               <div class="container">
                   ...
                   <div id="bannerContent">
                       ...
                       <a href="adminproduct.php" class="btn btn-danger">Shop Now</a>
                   </div>
                   </center>
               </div>
           </div>
